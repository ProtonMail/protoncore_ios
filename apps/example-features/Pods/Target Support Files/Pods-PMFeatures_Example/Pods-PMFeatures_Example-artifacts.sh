...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/PMCrypto/Crypto.xcframework" "" "false" "ios-arm64_x86_64-maccatalyst/Crypto.framework" "ios-arm64_armv7/Crypto.framework" "ios-arm64_x86_64-simulator/Crypto.framework"
fi
