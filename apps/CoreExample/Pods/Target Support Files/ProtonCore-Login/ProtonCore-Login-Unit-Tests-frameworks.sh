...
>>>>>>> Stashed changes
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ProtonCore-Authentication.default-UsingWireguardCrypto/ProtonCore_Authentication.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ProtonCore-Crypto/ProtonCore_Crypto.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ProtonCore-WireguardCrypto/ProtonCore_WireguardCrypto.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ProtonCore-PaymentsUI.default-UsingWireguardCrypto/ProtonCore_PaymentsUI.framework"
