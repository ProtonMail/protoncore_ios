...
final class ReceiptDetailsViewController: UITableViewController {
    ...
    private func createHeaderView() -> UIStackView? {
        ...
        button.addTarget(self, action: #selector(ReceiptDetailsViewController.validateReceiptTapped), for: .touchUpInside)
