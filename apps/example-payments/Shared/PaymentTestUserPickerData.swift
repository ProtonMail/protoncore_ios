//
//  PaymentTestUserPickerData.swift
...
final class PaymentTestUserPickerData: NSObject {
...
extension PaymentTestUserPickerData: UIPickerViewDataSource {
...
extension PaymentTestUserPickerData: UIPickerViewDelegate {
    ...
    func pickerView(
        ...
        let label = UILabel(text, font: UIFont.preferredFont(forTextStyle: .body), textColor: .label, alignment: .center)
