...
enum ObfuscatedConstants {
    ...
    static let onePassUserUsername: String = ""
    static let onePassUserPassword: String = ""
    
    static let twoPassUserUsername: String = ""
    static let twoPassUserPassword: String = ""
    static let twoPassUserMailboxPassword: String = ""
    
    static let onePassUserWith2FaUsername: String = ""
    ...
    static let usernameVpnFreeUserEmail: String = ""
    static let usernameVpnFreeUserPassword: String = ""
    ...
    static let sandboxPaymentAccountLogin: String = ""
