//
//  AccountDeletion+LocalizationTests.swift
//  ProtonCore-AccountDeletion-LocalizationTests - Created on 10.12.21.
//
...
import XCTest
@testable import ProtonCoreAccountSwitcher
...
final class AccountSwitcherLocalizationTests: XCTestCase {
