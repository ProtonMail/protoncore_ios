...
final class Container {
    ...
    func makeCreateAddressViewModel(username: String, data: CreateAddressData) -> CreateAddressViewModel {
        return CreateAddressViewModel(username: username, login: login, data: data)
    }
