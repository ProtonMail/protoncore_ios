...
public final class ServicePlanDataServiceMock: ServicePlanDataServiceProtocol {
    ...
    @FuncStub(ServicePlanDataServiceProtocol.detailsOfPlanCorrespondingToIAP, initialReturn: nil) public var detailsOfPlanCorrespondingToIAPStub
    public func detailsOfPlanCorrespondingToIAP(_ plan: InAppPurchasePlan) -> Plan? { detailsOfPlanCorrespondingToIAPStub(plan) }
