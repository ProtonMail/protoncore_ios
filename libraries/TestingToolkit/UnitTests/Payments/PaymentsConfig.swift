...
class TestAuthDelegate: AuthDelegate {
    ...
    weak var authSessionInvalidatedDelegateForLoginAndSignup: ProtonCoreServices.AuthSessionInvalidatedDelegate?
}
...
class UserCachedStatus: ServicePlanDataStorage {
    ...
    var iapSupportStatus: IAPSupportStatus = .enabled
}
