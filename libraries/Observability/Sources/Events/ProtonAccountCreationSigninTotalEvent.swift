//
//  ProtonAccountCreationSigninTotalEvent.swift
...
extension ObservabilityEvent where Payload == CounterPayloadWithLabels<ProtonAccountCreationSigninLabels> {
    public static func protonAccountCreationSigninTotal(status: SuccessOrFailureStatus) -> Self {
        .init(name: "ios_core_proton_account_creation_signin_total", labels: .init(status: status))
    }
}
