//
//  CoreTranslationV5Tests.swift
//  ProtonCore-CoreTranslation-V5 - Created on 07.11.20.
//
...
import XCTest
@testable import ProtonCore_CoreTranslation_V5

final class CoreTranslationV5Tests: XCTestCase {
    
    func testAllSubstitutionsAreFollowingTheExpectedFormat() {
        let localizedStringInstance = LocalizedString_V5()
        let elementWithIllegalSubstitution = LocalizedStringAccessors_V5.allCases
