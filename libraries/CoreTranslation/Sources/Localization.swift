...
public class LocalizedString {
    ...
    public lazy var _pu_plan_footer_desc_purchased = NSLocalizedString("Manage your subscription at protonmail.com.", bundle: Common.bundle, comment: "Plan footer purchased description")
