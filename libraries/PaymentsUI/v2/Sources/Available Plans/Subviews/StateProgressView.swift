    ...
    public var body: some View {
        HStack {
            if progressCompleted {
                ...
                ProgressView()
                      .progressViewStyle(CircularProgressViewStyle(tint: ColorProvider.IconAccent))
...
#Preview {
    StateProgressView(progressCompleted: .constant(false),
                      stateProgressText: "In progress",
                      stateCompleteText: "Task completed")
}
