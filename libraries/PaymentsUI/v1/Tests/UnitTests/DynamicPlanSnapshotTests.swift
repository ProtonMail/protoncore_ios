//
//  DynamicPlanSnapshotTests.swift
//  ProtonCore-PaymentsUI-Tests - Created on 03/07/2024.
//
...
@available(iOS 13, *)
final class DynamicPlanSnapshotTests: XCTestCase {
    ...
    func testCurrentDynamicSubscriptionLayout() async {
        await withFeatureFlags([.dynamicPlans]) {
            let currentPlan = CurrentPlan(subscriptions: [
                .init(title: "Mail Plus",
                      name: "mail2022",
                      ...
                      entitlements: [.progress(.init(type: "progress",
                                     ...
                                     .description(.init(type: "description",
                                                        text: "0 of 3 calendars",
                                                        iconName: "calendar-checkmark"
                                                       )),
                                     .description(.init(type: "description",
                                                        text: "Free VPN on a single device",
                                                        iconName: "shield"
                                                       )),
                                     .description(.init(type: "description",
            ...
            await snapshotCurrentDynamicSubscriptionScreen(currentPlan: currentPlan,
                                                           clientApp: .mail, modalPresentation: true)
        }
    }
...
extension CurrentPlan {
    func updated(cycle: Int? = nil, cycleDescription: String? = nil, currency: String? = nil, amount: Int? = nil, renew: Int? = nil, external: Subscription.PaymentMethod? = nil) -> CurrentPlan {
...
extension CurrentPlan.Subscription {
    func updated(cycle: Int?, cycleDescription: String?, currency: String?, amount: Int?, renew: Int?, external: PaymentMethod?) -> Self {
