...
extension LocalizedString {
    var _ad_delete_account_title: String { pmAccountDeletionConfiguration.deleteAccountWebviewTitle }
    var _ad_delete_network_error: String { pmAccountDeletionConfiguration.genericNetworkError }
    var _ad_delete_account_success: String { pmAccountDeletionConfiguration.accountDeletionSucceddedMessage }
    var _ad_delete_close_button: String { pmAccountDeletionConfiguration.genericNetworkErrorBannerCloseButton }
}
