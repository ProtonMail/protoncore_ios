...
struct PMTabBarConfig {
    ...
    ///   - backgroundColor: Background color of tabbar, default value is `UIColorManager.FloatyBackground`
    ...
    init(items: [PMTabBarItem], height: CGFloat?=nil, backgroundColor: UIColor?=nil, floatingHeight: CGFloat?=nil) {
        ...
        self.backgroundColor = backgroundColor ?? UIColorManager.FloatyBackground
    }
}
...
public struct PMTabBarItem {
    ...
    /// - Parameters:
    ///   - title: Item title
    ///   - color: Title color in normal status, default value is `UIColorManager.FloatyText`
    ///   - selectedColor: Title color in selected status, default value is `.white`
    ///   - selectedBgColor: Background color in selected status, default value is `UIColorManager.FloatyPressed`
    public init(title: String, color: UIColor?=nil, selectedColor: UIColor?=nil, selectedBgColor: UIColor?=nil) {
        self.title = title
        self.color = color ?? UIColorManager.FloatyText
        self.selectedColor = selectedColor ?? .white
        self.selectedBgColor = selectedBgColor ?? UIColorManager.FloatyPressed
        self.icon = nil
    }
