...
public final class PMTabBarBuilder {
    ...
    private var backgroundColor: UIColor = UIColorManager.FloatyBackground
    ...
    /// Sets background color of the tab bar controller, default value is `UIColorManager.FloatyBackground`
