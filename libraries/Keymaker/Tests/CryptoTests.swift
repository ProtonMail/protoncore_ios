//
//  CryptoTests.swift
//  ProtonCore-ProtonCore-Keymaker - Created on 10/12/2018.
//
...
/*
 ...
 These are performance tests to compare Crypto.framework to competition.
 Update when will be relevant again.
...
class CryptoTests: XCTestCase {
    ...
    func testCryptoDerive() {
        ...
        self.measure {
            ...
            let derivedKey = CryptoGo.SubtleDeriveKey(secret, salt, 32768, &error)
