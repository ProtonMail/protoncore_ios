...
Pod::Spec.new do |s|
  ...
  s.module_name      = 'ProtonCoreNetworking'
  s.version          = $version
  ...
  s.resource_bundles = {
    'Translations-Networking' => ['libraries/Networking/Sources/Resources/*']
  }

  s.source_files = "libraries/Networking/Sources/**/*"

  s.test_spec "Tests" do |test_spec|
    test_spec.source_files = "libraries/Networking/Tests/UnitTests/*.swift"
