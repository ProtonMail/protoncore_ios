...
Pod::Spec.new do |s|
    ...
    make_subspec = ->(spec, crypto) {
        spec.subspec "#{crypto_subspec(crypto)}" do |subspec|
            subspec.dependency "ProtonCore-CryptoGoInterface"
            subspec.dependency "ProtonCore-Crypto/#{crypto_subspec(crypto)}"
            ...
            subspec.test_spec 'Tests' do |test_spec|
                ...
                test_spec.dependency "ProtonCore-CryptoGoImplementation/#{crypto_subspec(crypto)}"
