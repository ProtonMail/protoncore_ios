...
if [ "$1" = "--regression" ]; then 
    ...
    TESTPLAN="Example-UITests-light"
    PARALLEL_TESTING_ENABLED="YES"
    PARALLEL_TESTING_WORKER_COUNT="4"
else
