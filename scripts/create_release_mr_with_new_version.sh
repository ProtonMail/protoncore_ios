...
echo "$LOG_PREFIX $ git push origin $RELEASE_BRANCH -o merge_request.create -o merge_request.target=$TARGET_BRANCH -o merge_request.remove_source_branch -o merge_request.assign=\"vjalencas\" -o merge_request.assign=\"amorral\" -o merge_request.assign=\"eackerma\""
git push origin $RELEASE_BRANCH -o merge_request.create -o merge_request.target=$TARGET_BRANCH -o merge_request.remove_source_branch -o merge_request.assign="vjalencas" -o merge_request.assign="amorral"  -o merge_request.assign="eackerma"
...
echo "$LOG_PREFIX $ git push origin $RELEASE_BRANCH -o merge_request.create -o merge_request.target=develop -o merge_request.remove_source_branch -o merge_request.assign=\"vjalencas\" -o merge_request.assign=\"amorral\" -o merge_request.assign=\"eackerma\""
git push origin $RELEASE_BRANCH -o merge_request.create -o merge_request.target=develop -o merge_request.remove_source_branch -o merge_request.assign="vjalencas" -o merge_request.assign="amorral" -o merge_request.assign="eackerma"
