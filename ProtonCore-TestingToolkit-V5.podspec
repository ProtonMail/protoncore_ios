...
Pod::Spec.new do |s|
    ...
    s.name             = 'ProtonCore-TestingToolkit-V5'
    s.module_name      = 'ProtonCore_TestingToolkit'
    s.version          = $version
    ...
    s.subspec 'UnitTests' do |unit_tests|
        ...
        unit_tests.subspec 'AccountDeletion' do |account_deletion|
            account_deletion.dependency 'ProtonCore-TestingToolkit-V5/UnitTests/Core', $version
            ...
            make_subspec = ->(spec, crypto, networking) {
                spec.subspec "#{crypto_and_networking_subspec(crypto, networking)}" do |subspec|
                    ...
                    subspec.dependency "ProtonCore-TestingToolkit-V5/UnitTests/Networking/#{networking_subspec(networking)}", $version
        ...
        unit_tests.subspec 'Authentication' do |authentication|
            authentication.dependency 'ProtonCore-TestingToolkit-V5/UnitTests/Core', $version

            make_subspec = ->(spec, crypto, networking) {
                spec.subspec "#{crypto_and_networking_subspec(crypto, networking)}" do |subspec|
                    subspec.dependency "ProtonCore-Authentication/#{crypto_and_networking_subspec(crypto, networking)}", $version
                    subspec.dependency "ProtonCore-TestingToolkit-V5/UnitTests/Services/#{networking_subspec(networking)}", $version
        ...
        unit_tests.subspec 'Authentication-KeyGeneration' do |authentication_keygeneration|
            authentication_keygeneration.dependency 'ProtonCore-TestingToolkit-V5/UnitTests/Core', $version
        ...
        unit_tests.subspec 'DataModel' do |data_model|
            data_model.dependency 'ProtonCore-TestingToolkit-V5/UnitTests/Core', $version
        ...
        unit_tests.subspec 'Doh' do |doh|
            doh.dependency 'ProtonCore-TestingToolkit-V5/UnitTests/Core', $version
        ...
        unit_tests.subspec 'HumanVerification' do |human_verification|
            human_verification.dependency 'ProtonCore-TestingToolkit-V5/UnitTests/Core', $version
        ...
        unit_tests.subspec 'Login' do |login|
            login.dependency 'ProtonCore-TestingToolkit-V5/UnitTests/Core', $version
            login.dependency 'ProtonCore-TestingToolkit-V5/UnitTests/DataModel', $version

            make_subspec = ->(spec, crypto, networking) {
                spec.subspec "#{crypto_and_networking_subspec(crypto, networking)}" do |subspec|
                    subspec.dependency "ProtonCore-TestingToolkit-V5/UnitTests/Authentication/#{crypto_and_networking_subspec(crypto, networking)}", $version
        ...
        unit_tests.subspec 'LoginUI' do |loginui|
            loginui.dependency 'ProtonCore-TestingToolkit-V5/UnitTests/Core', $version
            loginui.dependency 'ProtonCore-TestingToolkit-V5/UnitTests/DataModel', $version

            make_subspec = ->(spec, crypto, networking) {
                spec.subspec "#{crypto_and_networking_subspec(crypto, networking)}" do |subspec|
                    subspec.dependency "ProtonCore-TestingToolkit-V5/UnitTests/Authentication/#{crypto_and_networking_subspec(crypto, networking)}", $version
                    subspec.dependency "ProtonCore-LoginUI-V5/#{crypto_and_networking_subspec(crypto, networking)}", $version
                    subspec.dependency "ProtonCore-TestingToolkit-V5/UnitTests/HumanVerification/#{networking_subspec(networking)}", $version
                    subspec.dependency "ProtonCore-TestingToolkit-V5/UnitTests/Login/#{crypto_and_networking_subspec(crypto, networking)}", $version
                    subspec.dependency "ProtonCore-TestingToolkit-V5/UnitTests/Services/#{networking_subspec(networking)}", $version
        ...
        unit_tests.subspec 'Networking' do |networking|
            networking.dependency 'ProtonCore-TestingToolkit-V5/UnitTests/Core', $version
        ...
        unit_tests.subspec 'Services' do |services|
            services.dependency 'ProtonCore-TestingToolkit-V5/UnitTests/Core', $version
            services.dependency 'ProtonCore-TestingToolkit-V5/UnitTests/DataModel', $version
            services.dependency 'ProtonCore-TestingToolkit-V5/UnitTests/Doh', $version
        ...
        unit_tests.subspec 'Payments' do |payments|
            payments.dependency 'ProtonCore-TestingToolkit-V5/UnitTests/Core', $version
