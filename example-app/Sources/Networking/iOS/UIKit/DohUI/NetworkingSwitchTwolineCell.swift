//
//  NetworkingSwitchTwolineCell.swift
//  ExampleApp - Created on 3/17/15.
//
...
protocol NetworkingSwitchTwolineCellDelegate {
    func mailto()
}

@IBDesignable class NetworkingSwitchTwolineCell: UITableViewCell, UITextViewDelegate {
    typealias ActionStatus = (_ isOK: Bool) -> Void
    typealias switchActionBlock = (_ cell: NetworkingSwitchTwolineCell?,
                                   _ newStatus: Bool,
                                   _ feedback: @escaping ActionStatus) -> Void

    
    var callback : switchActionBlock?
    var delegate : NetworkingSwitchTwolineCellDelegate?
...
//        bottomTextView.delegate = self
    ...
    func configCell(_ topline : String,
                    bottomLine : NSMutableAttributedString,
                    showSwitcher : Bool,
                    status : Bool,
                    complete : switchActionBlock?) {
...
extension NetworkingSwitchTwolineCell: IBDesignableLabeled {
