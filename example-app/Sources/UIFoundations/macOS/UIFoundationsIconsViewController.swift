...
final class UIFoundationsIconsViewController: NSViewController {
    ...
    let data: [(String, [(NSImage, String, String)])] = [
        ...
        ("Proton Icon Set", [
            ...
            (IconProvider.lockOpenCheckFilled1, "ic-lock-open-check-filled-1", "lockOpenCheckFilled1"),
            (IconProvider.lockOpenCheckFilled2, "ic-lock-open-check-filled-2", "lockOpenCheckFilled2"),
