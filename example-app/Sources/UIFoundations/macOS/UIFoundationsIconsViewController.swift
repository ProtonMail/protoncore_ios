...
//  ExampleApp - Created on 17/03/2022.
//  
...
final class UIFoundationsIconsViewController: NSViewController {
    ...
    let data: [(String, [(NSImage, String, String)])] = [
        ...
        ("Proton Icon Set", [
            ...
            (IconProvider.arrowInToRectangle, "ic-arrow-in-to-rectangle", "arrowInToRectangle"),
            ...
            (IconProvider.brandProtonCalendar, "ic-brand-proton-calendar", "brandProtonCalendar"),
            (IconProvider.brandProtonDrive, "ic-brand-proton-drive", "brandProtonDrive"),
            (IconProvider.brandProtonMail, "ic-brand-proton-mail", "brandProtonMail"),
            (IconProvider.brandProtonVpn, "ic-brand-proton-vpn", "brandProtonVpn"),
            (IconProvider.brandProton, "ic-brand-proton", "brandProton"),
            ...
            (IconProvider.checkmarkCircleFilled, "ic-checkmark-circle-filled", "checkmarkCircleFilled"),
            (IconProvider.checkmarkCircle, "ic-checkmark-circle", "checkmarkCircle"),
            (IconProvider.checkmarkTriple, "ic-checkmark-triple", "checkmarkTriple"),
            ...
            (IconProvider.clockPaperPlane, "ic-clock-paper-plane", "clockPaperPlane"),
            ...
            (IconProvider.emoji, "ic-emoji", "emoji"),
            ...
            (IconProvider.envelopeMagnifyingGlass, "ic-envelope-magnifying-glass", "envelopeMagnifyingGlass"),
            ...
            (IconProvider.exclamationTriangleFilled, "ic-exclamation-triangle-filled", "exclamationTriangleFilled"),
            ...
            (IconProvider.forward, "ic-forward", "forward"),
            ...
            (IconProvider.magicWand, "ic-magic-wand", "magicWand"),
            ...
            (IconProvider.minusCircle1, "ic-minus-circle-1", "minusCircle1"),
            ...
            (IconProvider.moneyBills, "ic-money-bills", "moneyBills"),
            ...
            (IconProvider.replyAll, "ic-reply-all", "replyAll"),
            (IconProvider.reply, "ic-reply", "reply"),
