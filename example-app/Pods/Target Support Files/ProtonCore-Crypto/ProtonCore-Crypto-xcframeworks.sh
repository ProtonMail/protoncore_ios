...
install_xcframework "${PODS_ROOT}/../../vendor/Crypto/Crypto.xcframework" "ProtonCore-Crypto" "framework" "ios-arm64_x86_64-maccatalyst" "ios-arm64" "ios-arm64_x86_64-simulator"
