...
public class NetworkingTroubleShootViewController: UITableViewController, ViewModelProtocol, Coordinated {
    ...
    internal var viewModel : NetworkingTroubleShootViewModel!
    internal var coordinator : NetworkingTroubleShootCoordinator?
    
    public func set(viewModel: NetworkingTroubleShootViewModel) {
        self.viewModel = viewModel
    }
    
    public func set(coordinator: NetworkingTroubleShootCoordinator) {
    ...
    public override func viewDidLoad() {
        ...
        let newBackButton = UIBarButtonItem(title: "back", // LocalString._general_back_action,
                                            ...
                                            target: self,
                                            action: #selector(NetworkingTroubleShootViewController.back(sender:)))
    ...
    public override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let cellout = cell as? NetworkingSwitchTwolineCell {
            if item == .allowSwitch {
...
extension NetworkingTroubleShootViewController : NetworkingSwitchTwolineCellDelegate, MFMailComposeViewControllerDelegate {
    func mailto() {
        openMFMail()
    }
